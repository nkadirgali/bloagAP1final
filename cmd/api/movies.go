...
func (app *application) deleteMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	//	fmt.Println(user_id)
	input := data.Role{UserID: user_id}
	// flag := app.models.Roles.GetByUserID(input)
	// fmt.Println(flag)
	if !app.models.Roles.GetByUserID(&input) {
		app.errorResponse(w, r, 404, "only admin can delete movies")
		return
	}
